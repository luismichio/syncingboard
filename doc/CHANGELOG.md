...
- **CI fix: changelog MDX builds again** — a bullet contained {swap:true} inline, which next-mdx-remote treats as a JSX expression (acorn failed compounding /docs/changelog, killing the build). Reworded; docs page prerenders again.
